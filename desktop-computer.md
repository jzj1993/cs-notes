...
通常显卡、电源、主板芯片等都有自带的散热器，大部分用户只需要考虑CPU的散热器即可。
...
带有热管的散热器。图片来源： [Thermalright True Spirit 90 | Review | Technic3D](https://www.technic3d.com/review/kuehler/1439-thermalright-true-spirit-90/1.htm)
...
Turemetal发布的无风扇机箱。图片来源：[Turemetal测试RTX 3080显卡无风扇散热方案：350W，87℃|CPU|显卡|机箱_新浪科技_新浪网 (sina.com.cn)](https://finance.sina.com.cn/tech/2021-02-19/doc-ikftpnny7581846.shtml)
...
猫头鹰NH-D15风冷散热器。图片来源： [NH-D15 (noctua.at)](https://noctua.at/en/nh-d15)

![Noctua NH-D15 Unboxing, Overview & Installation LGA 115x & AM4 - YouTube](desktop-computer.assets/maxresdefault.jpg)

安装在M-ATX主板上的NH-D15。图片来源： [Noctua NH-D15 Unboxing, Overview & Installation LGA 115x & AM4 - YouTube](https://www.youtube.com/watch?v=E6YfbCuszUI)



### 水冷

热管还是被动将热量从CPU导出的。而水冷则是利用水泵+液体（通常就是水）将热量从CPU快速带走，再用风扇风冷的方式散热。

相比风冷散热，水冷有几个优点：

1. 带走热量的效率更高。
2. 热管是金属的，不容易弯曲，因此被动散热器一般都是固定形状，尺寸容易受限。但是水冷可以用软管装水，散热片可以放到机箱边缘，于是可以做的很大，而且风道更加合理（风道后面会讲）。
3. 水的比热容较大，所以对于CPU短时间的高温，水可以直接把热量储存起来，而不至于温度上升过快。

一些常见但是没必要的担忧：

1. 水冷有漏液引起短路烧坏电脑的风险，但是随着技术进步，这种问题很少再发生。万一真发生了一般可以申请水冷厂商赔偿。
2. 水泵有损坏的风险，导致CPU无法散热。但是由于CPU都有过热保护，后果就是立即关机，一般不会烧坏。
3. 水冷的原理是带走热量，不会因为散热效果太好导致CPU温度低于室温产生冷凝水，引起CPU短路。



#### 水冷的规格

一般根据散热片或者称为水排的尺寸，将水冷分为常见的几种规格。其中280使用的是14cm风扇，其他都是12cm风扇。
...
- 一体式水冷适合大多数人，水冷头、管道、冷排都是整体不可拆卸的。开箱即用，价格便宜，简单可靠。
...
- 尺寸：机箱的整体尺寸，以及内部尺寸的计算，是否能装下挑选好的主板、散热器、电源、显卡、硬盘。如果追求高配置、小体积的主机，就需要做比较细致的计算。
...
左图是一个比较经典的家用ATX机箱结构，使用风冷散热，带有光驱位。

右图则是一个常见的工作站机箱结构，支持E-ATX主板，多个显卡，以及大量可以从机箱正面热插拔的2.5 / 3.5寸硬盘。
...
- 图2：主板支持ATX或M-ATX，减少/去掉硬盘位，或者挪到机箱背面，显卡严格限长，减小机箱尺寸，电源放在上面或下面，有些支持水冷。例如乔伯斯U3。
- 图3：电源移动到右侧，这样显卡可以更长，电源有轻微限长要求。不需要更多PCI-E设备，还可以在底部安装硬盘 / 第二个水冷。例如机械大师C34。
- 图4：进一步缩小为ITX主板，只支持一块显卡，结构更加紧凑。**ITX机箱可以轻松达到A4纸的尺寸**，装到书包里随身背着，但是**容易有散热问题**。
- 图5：显卡支持竖装，和主板平行，CPU使用水冷，或者严格限制高度的涡轮型风冷散热器，电源不限长。
- 图6：电源叠放到CPU上方，支持第二个水冷。

![image-20210601033450891](desktop-computer.assets/image-20210601033450891.png)
...
- 数量、位置：ATX机箱、主板会提供最多7个PCI-E扩展槽位，大型设备例如显卡常常会占用2个PCI-E位置。另外考虑到散热，最好不要安装过于密集，结合主板上的槽位考虑。

**显卡：**

- 长度：大型显卡特别是三风扇显卡长度很夸张，但是机箱长度有限，需要考虑。有些机箱前面板可以装水冷或风扇，装上后显卡最大支持长度还会进一步减少。
- 高度：通常显卡高度不会超出机箱宽度，少数很扁的机箱可能会另作说明。
- 厚度：常见的独立显卡会占用2个PCI-E槽位，前面已经说了。
...
这里再举一个例子，机械大师C34机箱，非常紧凑，可以在配置接近的情况下（ATX / M-ATX主板，ATX电源，常规尺寸显卡），比某些标准机箱减少一半的体积，但安装难度大，很容易翻车。
